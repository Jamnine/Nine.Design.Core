namespace Nine.Design.Core.Model
{
    ...
    public class MessageModel<T>
    {
        ...
        /// <param name="response">数据</param>
        /// <returns></returns>
        public static MessageModel<T> Success(string msg, long traceId,T response)
        {
            return Message(true, msg, traceId, response);
        }
        /// <summary>
        /// 返回失败
        /// </summary>
        ...
        /// <param name="response">数据</param>
        /// <returns></returns>
        public static MessageModel<T> Message(bool success, string msg,long traceId, T response)
        {
            return new MessageModel<T>() { msg = msg, TraceId= traceId,response = response, success = success };
        }
    }
